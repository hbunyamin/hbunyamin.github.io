---
title: '[EN] Variance and Covariance of Categorical Distribution'
date: 2020-09-18
permalink: /ml-2/Expectation_Variance_and_Covariance_of_Categorical_Distribution/
excerpt: "This article discusses properties of categorical distribution" 
tags:
  - probability
  - statistics
---
...
[![img1]({{ site.baseurl }}/assets/images/one-hot-encoding.png){:class="img-responsive"}]({{ site.baseurl }}/assets/images/one-hot-encoding.png) \\( \pmb{\text{Figure 1}} \\) : A categorical variable ( \\( \text{Color} \\)) and its values ( \\( \text{Red} \\), \\( \text{Yellow} \\), and \\( \text{Green} \\) ). Image taken from <a href="https://www.kaggle.com/alexisbcook/categorical-variables">Kaggle</a>, some rights reserved.{: style="text-align: center;"}
