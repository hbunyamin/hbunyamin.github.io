---
title: '[EN] Completing the Square for Normal Model with Multiple Observations'
date: 2021-04-12
permalink: /data-science-2/Completing_the_Square_for_Multivariate_Model/
excerpt: "This article explains friendly steps to complete the square of normal distribution" 
tags:
  - probability
  - statistics
---
...
[![img1]({{ site.baseurl }}/assets/images/normal-dist.jpg){:class="img-responsive"}]({{ site.baseurl }}/assets/images/normal-dist.jpg)        
\\(\pmb{\text{Figure 1}}\\): Example of a normal distribution consisting a horde of rabbits. Image taken from <a href="https://vimeo.com/75089338">Casey Dunn</a>, some rights reserved.       
